          ...
          <div className="hero__trust-container">
            ...
            <div className="hero__body-text">
              ...
              <p className="hero__text-body">
                <strong>That's where Avaris Sales Solutions comes in.</strong>{" "}
                We provide 24/7 outsourced sales support, lead management, and
                structured follow-ups so every opportunity receives the
                attention it deserves — even when you're offline.
              </p>
              <p className="hero__text-body">
